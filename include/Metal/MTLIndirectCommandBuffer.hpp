...
class IndirectCommandBuffer
 ...
 public:
  ...
  class IndirectComputeCommand* indirectComputeCommand(
...
_MTL_INLINE bool MTL::IndirectCommandBufferDescriptor::inheritPipelineState()
  const {
...
_MTL_INLINE void MTL::IndirectCommandBufferDescriptor::setInheritBuffers(
  bool inheritBuffers) {
...
_MTL_INLINE bool MTL::IndirectCommandBufferDescriptor::supportRayTracing()
  const {
