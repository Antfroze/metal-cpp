...
_MTL_INLINE void MTL::CommandBufferDescriptor::setRetainedReferences(
...
_MTL_INLINE void MTL::CommandBuffer::addScheduledHandler(
  ...
  addScheduledHandler(
    ^(MTL::CommandBuffer* pCommandBuffer) { blockFunction(pCommandBuffer); });
}
...
// property: errorOptions
_MTL_INLINE MTL::CommandBufferErrorOption MTL::CommandBuffer::errorOptions()
  const {
  return Object::sendMessage<MTL::CommandBufferErrorOption>(
    this, _MTL_PRIVATE_SEL(errorOptions));
}
...
_MTL_INLINE void MTL::CommandBuffer::presentDrawable(
  const MTL::Drawable* drawable) {
  Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(presentDrawable_), drawable);
}

// method: presentDrawable:atTime:
_MTL_INLINE void MTL::CommandBuffer::presentDrawableAtTime(
  const MTL::Drawable* drawable, CFTimeInterval presentationTime) {
...
MTL::CommandBuffer::accelerationStructureCommandEncoder(
  ...
  return Object::sendMessage<MTL::AccelerationStructureCommandEncoder*>(
    this, _MTL_PRIVATE_SEL(accelerationStructureCommandEncoderWithDescriptor_),
    descriptor);
}
