...
class CompileOptions : public NS::Copying<CompileOptions> {
 public:
  ...
  void setAllowReferencingUndefinedSymbols(
...
class Library : public NS::Referencing<Library> {
 public:
  ...
  class Function* newFunction(
    const NS::String* name, const class FunctionConstantValues* constantValues,
    NS::Error** error);
  ...
  class Function* newIntersectionFunction(
    const class IntersectionFunctionDescriptor* descriptor, NS::Error** error);
...
_MTL_INLINE void MTL::CompileOptions::setLanguageVersion(
  MTL::LanguageVersion languageVersion) {
...
_MTL_INLINE void MTL::CompileOptions::setLibraryType(
  MTL::LibraryType libraryType) {
...
_MTL_INLINE void MTL::CompileOptions::setInstallName(
  const NS::String* installName) {
...
_MTL_INLINE void MTL::CompileOptions::setPreserveInvariance(
...
_MTL_INLINE NS::UInteger MTL::CompileOptions::maxTotalThreadsPerThreadgroup()
  const {
...
_MTL_INLINE MTL::Function* MTL::Library::newFunction(
  const MTL::FunctionDescriptor* descriptor, NS::Error** error) {
  return Object::sendMessage<MTL::Function*>(
