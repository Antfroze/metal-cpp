...
_MTL_INLINE void MTL::VertexBufferLayoutDescriptor::setStride(
  NS::UInteger stride) {
...
_MTL_INLINE void MTL::VertexBufferLayoutDescriptor::setStepRate(
...
_MTL_INLINE void MTL::VertexAttributeDescriptor::setFormat(
...
_MTL_INLINE void MTL::VertexAttributeDescriptor::setOffset(
  NS::UInteger offset) {
...
_MTL_INLINE void MTL::VertexAttributeDescriptor::setBufferIndex(
