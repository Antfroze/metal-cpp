...
using NewComputePipelineStateWithReflectionCompletionHandler = void (^)(
  class ComputePipelineState*, class ComputePipelineReflection*, NS::Error*);
...
NS::Array* CopyAllDevicesWithObserver(
  NS::Object** pOutObserver, const DeviceNotificationHandlerFunction& handler);
...
class Device : public NS::Referencing<Device> {
 public:
  ...
  MTL::SizeAndAlign heapTextureSizeAndAlign(
    const class TextureDescriptor* desc);
  ...
  class DepthStencilState* newDepthStencilState(
    const class DepthStencilDescriptor* descriptor);
  ...
  class Texture* newSharedTexture(
    const class SharedTextureHandle* sharedHandle);

  class SamplerState* newSamplerState(
    const class SamplerDescriptor* descriptor);
  ...
  class ComputePipelineState* newComputePipelineState(
    const class Function* computeFunction, NS::Error** error);
  ...
  NS::UInteger minimumTextureBufferAlignmentForPixelFormat(
    MTL::PixelFormat format);
  ...
  class SharedEvent* newSharedEvent(
    const class SharedEventHandle* sharedEventHandle);
  ...
  class IOCommandQueue* newIOCommandQueue(
    const class IOCommandQueueDescriptor* descriptor, NS::Error** error);
  ...
  class ArgumentEncoder* newArgumentEncoder(
    const class BufferBinding* bufferBinding);
  ...
  class BinaryArchive* newBinaryArchive(
    const class BinaryArchiveDescriptor* descriptor, NS::Error** error);
...
_MTL_INLINE void MTL::ArgumentDescriptor::setArrayLength(
...
_MTL_INLINE void MTL::ArgumentDescriptor::setAccess(
  MTL::ArgumentAccess access) {
...
_MTL_INLINE void MTL::ArgumentDescriptor::setTextureType(
...
_MTL_INLINE NS::UInteger MTL::ArgumentDescriptor::constantBlockAlignment()
  const {
...
extern "C" NS::Array* MTLCopyAllDevicesWithObserver(
  NS::Object**, MTL::DeviceNotificationHandlerBlock);
...
_NS_EXPORT NS::Array* MTL::CopyAllDevicesWithObserver(
  NS::Object** pOutObserver, DeviceNotificationHandlerBlock handler) {
#if TARGET_OS_OSX
...
_MTL_INLINE MTL::ReadWriteTextureTier MTL::Device::readWriteTextureSupport()
  const {
...
_MTL_INLINE MTL::ArgumentBuffersTier MTL::Device::argumentBuffersSupport()
  const {
...
_MTL_INLINE MTL::SizeAndAlign MTL::Device::heapBufferSizeAndAlign(
...
_MTL_INLINE MTL::Heap* MTL::Device::newHeap(
  const MTL::HeapDescriptor* descriptor) {
...
_MTL_INLINE MTL::Buffer* MTL::Device::newBuffer(
  const void* pointer, NS::UInteger length, MTL::ResourceOptions options,
  void (^deallocator)(void*, NS::UInteger)) {
  return Object::sendMessage<MTL::Buffer*>(
    this,
...
_MTL_INLINE MTL::Texture* MTL::Device::newTexture(
...
_MTL_INLINE MTL::Texture* MTL::Device::newTexture(
  const MTL::TextureDescriptor* descriptor, const IOSurfaceRef iosurface,
  NS::UInteger plane) {
  return Object::sendMessage<MTL::Texture*>(
...
_MTL_INLINE MTL::Library* MTL::Device::newLibrary(
  const MTL::StitchedLibraryDescriptor* descriptor, NS::Error** error) {
  return Object::sendMessage<MTL::Library*>(
...
_MTL_INLINE bool MTL::Device::supportsTextureSampleCount(
  NS::UInteger sampleCount) {
  return Object::sendMessageSafe<bool>(
...
_MTL_INLINE void MTL::Device::getDefaultSamplePositions(
  MTL::SamplePosition* positions, NS::UInteger count) {
  Object::sendMessage<void>(
    this, _MTL_PRIVATE_SEL(getDefaultSamplePositions_count_), positions, count);
}
...
_MTL_INLINE bool MTL::Device::supportsRasterizationRateMap(
  NS::UInteger layerCount) {
  return Object::sendMessageSafe<bool>(
...
_MTL_INLINE MTL::IOFileHandle* MTL::Device::newIOHandle(
  const NS::URL* url, MTL::IOCompressionMethod compressionMethod,
  NS::Error** error) {
  return Object::sendMessage<MTL::IOFileHandle*>(
...
_MTL_INLINE void MTL::Device::convertSparsePixelRegions(
  const MTL::Region* pixelRegions, MTL::Region* tileRegions, MTL::Size tileSize,
...
_MTL_INLINE void MTL::Device::convertSparseTileRegions(
  const MTL::Region* tileRegions, MTL::Region* pixelRegions, MTL::Size tileSize,
  NS::UInteger numRegions) {
  Object::sendMessage<void>(
    this,
    _MTL_PRIVATE_SEL(
...
_MTL_INLINE NS::UInteger MTL::Device::sparseTileSizeInBytes(
  MTL::SparsePageSize sparsePageSize) {
  return Object::sendMessage<NS::UInteger>(
...
_MTL_INLINE bool MTL::Device::supportsCounterSampling(
  MTL::CounterSamplingPoint samplingPoint) {
  return Object::sendMessageSafe<bool>(
...
_MTL_INLINE MTL::DynamicLibrary* MTL::Device::newDynamicLibrary(
...
_MTL_INLINE NS::UInteger MTL::Device::maximumConcurrentCompilationTaskCount()
  const {
  return Object::sendMessage<NS::UInteger>(
