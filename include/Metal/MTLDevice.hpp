...
namespace MTL {
    ...
    using NewRenderPipelineStateCompletionHandler = void (^)(class RenderPipelineState*,
                                                             NS::Error*);
    ...
    using NewComputePipelineStateCompletionHandler = void (^)(class ComputePipelineState*,
                                                              NS::Error*);
    ...
    class Device : public NS::Referencing<Device> {
       public:
        ...
        class RenderPipelineState* newRenderPipelineState(
            const class MeshRenderPipelineDescriptor* descriptor, MTL::PipelineOption options,
            const MTL::AutoreleasedRenderPipelineReflection* reflection, NS::Error** error);
        ...
        class IOCommandQueue* newIOCommandQueue(const class IOCommandQueueDescriptor* descriptor,
                                                NS::Error** error);
