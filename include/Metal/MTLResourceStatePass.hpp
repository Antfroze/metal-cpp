...
class ResourceStatePassSampleBufferAttachmentDescriptorArray
 ...
 public:
  ...
  class ResourceStatePassSampleBufferAttachmentDescriptor* object(
...
_MTL_INLINE NS::UInteger MTL::
  ResourceStatePassSampleBufferAttachmentDescriptor::startOfEncoderSampleIndex()
    const {
...
_MTL_INLINE NS::UInteger MTL::
  ResourceStatePassSampleBufferAttachmentDescriptor::endOfEncoderSampleIndex()
    const {
  return Object::sendMessage<NS::UInteger>(
