...
class FunctionStitchingFunctionNode
 ...
 public:
  ...
  MTL::FunctionStitchingFunctionNode* init(
    const NS::String* name, const NS::Array* arguments,
...
class FunctionStitchingGraph : public NS::Copying<FunctionStitchingGraph> {
 public:
  ...
  MTL::FunctionStitchingGraph* init(
...
_MTL_INLINE NS::UInteger MTL::FunctionStitchingInputNode::argumentIndex()
  const {
  return Object::sendMessage<NS::UInteger>(this,
                                           _MTL_PRIVATE_SEL(argumentIndex));
}

_MTL_INLINE void MTL::FunctionStitchingInputNode::setArgumentIndex(
...
_MTL_INLINE void MTL::FunctionStitchingFunctionNode::setName(
...
_MTL_INLINE void MTL::FunctionStitchingFunctionNode::setArguments(
...
_MTL_INLINE NS::Array* MTL::FunctionStitchingFunctionNode::controlDependencies()
  const {
  return Object::sendMessage<NS::Array*>(this,
                                         _MTL_PRIVATE_SEL(controlDependencies));
}
...
_MTL_INLINE void MTL::FunctionStitchingGraph::setFunctionName(
...
_MTL_INLINE void MTL::StitchedLibraryDescriptor::setFunctions(
  const NS::Array* functions) {
