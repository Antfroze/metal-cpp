...
namespace MTL {
    ...
    class RenderCommandEncoder : public NS::Referencing<RenderCommandEncoder, CommandEncoder> {
       public:
        ...
        void setVertexBuffers(const class Buffer* const buffers[], const NS::UInteger offsets[],
                              NS::Range range);
        ...
        void setVertexAccelerationStructure(
            const class AccelerationStructure* accelerationStructure, NS::UInteger bufferIndex);
        ...
        void setFragmentBuffers(const class Buffer* const buffers[], const NS::UInteger offsets[],
                                NS::Range range);
        ...
        void setObjectBuffers(const class Buffer* const buffers[], const NS::UInteger* offsets,
                              NS::Range range);
        ...
        void setObjectSamplerState(const class SamplerState* sampler, float lodMinClamp,
                                   float lodMaxClamp, NS::UInteger index);
        ...
        void setMeshBuffers(const class Buffer* const buffers[], const NS::UInteger* offsets,
                            NS::Range range);
        ...
        void setTileBuffers(const class Buffer* const buffers[], const NS::UInteger* offsets,
                            NS::Range range);
        ...
        void setTileVisibleFunctionTables(const class VisibleFunctionTable* const functionTables[],
                                          NS::Range range);
...
_MTL_INLINE void MTL::RenderCommandEncoder::setObjectBuffer(const MTL::Buffer* buffer,
                                                            NS::UInteger offset,
                                                            NS::UInteger index) {
    Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setObjectBuffer_offset_atIndex_), buffer,
                              offset, index);
}
...
_MTL_INLINE void MTL::RenderCommandEncoder::setObjectBufferOffset(NS::UInteger offset,
                                                                  NS::UInteger index) {
    Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setObjectBufferOffset_atIndex_), offset,
                              index);
}
...
_MTL_INLINE void MTL::RenderCommandEncoder::setObjectTextures(const MTL::Texture* const textures[],
                                                              NS::Range range) {
    Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setObjectTextures_withRange_), textures,
                              range);
}
...
_MTL_INLINE void MTL::RenderCommandEncoder::setObjectSamplerState(const MTL::SamplerState* sampler,
                                                                  NS::UInteger index) {
    Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setObjectSamplerState_atIndex_), sampler,
                              index);
}
...
_MTL_INLINE void MTL::RenderCommandEncoder::setObjectSamplerStates(
    ...
    NS::Range range) {
    Object::sendMessage<void>(
        this, _MTL_PRIVATE_SEL(setObjectSamplerStates_lodMinClamps_lodMaxClamps_withRange_),
        samplers, lodMinClamps, lodMaxClamps, range);
}
...
_MTL_INLINE void MTL::RenderCommandEncoder::setMeshSamplerState(const MTL::SamplerState* sampler,
                                                                ...
                                                                NS::UInteger index) {
    Object::sendMessage<void>(
        this, _MTL_PRIVATE_SEL(setMeshSamplerState_lodMinClamp_lodMaxClamp_atIndex_), sampler,
        lodMinClamp, lodMaxClamp, index);
}
