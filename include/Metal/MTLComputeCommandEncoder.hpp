...
_MTL_INLINE void MTL::ComputeCommandEncoder::setBuffer(
...
_MTL_INLINE void MTL::ComputeCommandEncoder::setTexture(
...
_MTL_INLINE void MTL::ComputeCommandEncoder::setThreadgroupMemoryLength(
  ...
  Object::sendMessage<void>(
    this, _MTL_PRIVATE_SEL(setThreadgroupMemoryLength_atIndex_), length, index);
}
...
// method: updateFence:
_MTL_INLINE void MTL::ComputeCommandEncoder::updateFence(
  const MTL::Fence* fence) {
  Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(updateFence_), fence);
}

// method: waitForFence:
_MTL_INLINE void MTL::ComputeCommandEncoder::waitForFence(
  const MTL::Fence* fence) {
  Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(waitForFence_), fence);
}

// method: useResource:usage:
_MTL_INLINE void MTL::ComputeCommandEncoder::useResource(
...
_MTL_INLINE void MTL::ComputeCommandEncoder::useHeaps(
