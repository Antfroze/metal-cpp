...
class TextureDescriptor : public NS::Copying<TextureDescriptor> {
 public:
  ...
  static class TextureDescriptor* textureBufferDescriptor(
...
_MTL_INLINE void MTL::TextureDescriptor::setTextureType(
  MTL::TextureType textureType) {
...
_MTL_INLINE void MTL::TextureDescriptor::setPixelFormat(
...
_MTL_INLINE void MTL::TextureDescriptor::setMipmapLevelCount(
...
_MTL_INLINE void MTL::TextureDescriptor::setSampleCount(
...
_MTL_INLINE void MTL::TextureDescriptor::setArrayLength(
...
_MTL_INLINE MTL::ResourceOptions MTL::TextureDescriptor::resourceOptions()
  const {
...
_MTL_INLINE void MTL::TextureDescriptor::setCpuCacheMode(
...
_MTL_INLINE void MTL::TextureDescriptor::setStorageMode(
...
_MTL_INLINE MTL::HazardTrackingMode MTL::TextureDescriptor::hazardTrackingMode()
  const {
...
// property: swizzle
_MTL_INLINE MTL::TextureSwizzleChannels MTL::TextureDescriptor::swizzle()
  const {
  return Object::sendMessage<MTL::TextureSwizzleChannels>(
    this, _MTL_PRIVATE_SEL(swizzle));
}

_MTL_INLINE void MTL::TextureDescriptor::setSwizzle(
  MTL::TextureSwizzleChannels swizzle) {
...
_MTL_INLINE MTL::Texture* MTL::Texture::newRemoteTextureViewForDevice(
