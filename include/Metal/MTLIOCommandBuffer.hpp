...
_MTL_INLINE void MTL::IOCommandBuffer::addCompletedHandler(
  ...
  addCompletedHandler(
    ^(IOCommandBuffer* pCommandBuffer) { blockFunction(pCommandBuffer); });
}
...
_MTL_INLINE void MTL::IOCommandBuffer::loadBytes(
  const void* pointer, NS::UInteger size, const MTL::IOFileHandle* sourceHandle,
  NS::UInteger sourceHandleOffset) {
...
_MTL_INLINE void MTL::IOCommandBuffer::copyStatusToBuffer(
...
_MTL_INLINE void MTL::IOCommandBuffer::pushDebugGroup(
...
_MTL_INLINE void MTL::IOCommandBuffer::signalEvent(
  const MTL::SharedEvent* event, uint64_t value) {
