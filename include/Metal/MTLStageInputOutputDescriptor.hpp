...
_MTL_INLINE MTL::StepFunction MTL::BufferLayoutDescriptor::stepFunction()
  const {
  return Object::sendMessage<MTL::StepFunction>(this,
                                                _MTL_PRIVATE_SEL(stepFunction));
}

_MTL_INLINE void MTL::BufferLayoutDescriptor::setStepFunction(
  MTL::StepFunction stepFunction) {
...
_MTL_INLINE void MTL::BufferLayoutDescriptor::setStepRate(
...
_MTL_INLINE void MTL::AttributeDescriptor::setFormat(
  MTL::AttributeFormat format) {
...
_MTL_INLINE void MTL::AttributeDescriptor::setBufferIndex(
...
// method: objectAtIndexedSubscript:
_MTL_INLINE MTL::AttributeDescriptor* MTL::AttributeDescriptorArray::object(
  NS::UInteger index) {
...
_MTL_INLINE void MTL::StageInputOutputDescriptor::setIndexType(
  MTL::IndexType indexType) {
  Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setIndexType_), indexType);
}

// property: indexBufferIndex
_MTL_INLINE NS::UInteger MTL::StageInputOutputDescriptor::indexBufferIndex()
  const {
