...
class BlitPassSampleBufferAttachmentDescriptorArray
 ...
 public:
  ...
  class BlitPassSampleBufferAttachmentDescriptor* object(
    NS::UInteger attachmentIndex);

  void setObject(
    const class BlitPassSampleBufferAttachmentDescriptor* attachment,
    NS::UInteger attachmentIndex);
};
...
class BlitPassDescriptor : public NS::Copying<BlitPassDescriptor> {
 public:
  ...
  class BlitPassSampleBufferAttachmentDescriptorArray* sampleBufferAttachments()
    const;
};
