...
namespace MTL {
    ...
    class AccelerationStructurePassSampleBufferAttachmentDescriptorArray
       ...
       public:
        ...
        class AccelerationStructurePassSampleBufferAttachmentDescriptor* object(
            NS::UInteger attachmentIndex);

        void setObject(
            const class AccelerationStructurePassSampleBufferAttachmentDescriptor* attachment,
            NS::UInteger attachmentIndex);
    };
