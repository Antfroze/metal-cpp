...
class BlitCommandEncoder
 ...
 public:
  ...
  void optimizeIndirectCommandBuffer(
    const class IndirectCommandBuffer* indirectCommandBuffer, NS::Range range);
...
_MTL_INLINE void MTL::BlitCommandEncoder::synchronizeResource(
...
// method: waitForFence:
_MTL_INLINE void MTL::BlitCommandEncoder::waitForFence(
...
_MTL_INLINE void MTL::BlitCommandEncoder::optimizeContentsForGPUAccess(
  const MTL::Texture* texture, NS::UInteger slice, NS::UInteger level) {
  Object::sendMessage<void>(
    this, _MTL_PRIVATE_SEL(optimizeContentsForGPUAccess_slice_level_), texture,
    slice, level);
}
...
_MTL_INLINE void MTL::BlitCommandEncoder::optimizeContentsForCPUAccess(
  const MTL::Texture* texture, NS::UInteger slice, NS::UInteger level) {
  Object::sendMessage<void>(
    this, _MTL_PRIVATE_SEL(optimizeContentsForCPUAccess_slice_level_), texture,
    slice, level);
}
