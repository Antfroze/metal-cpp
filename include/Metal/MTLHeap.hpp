...
_MTL_INLINE void MTL::HeapDescriptor::setStorageMode(
...
_MTL_INLINE void MTL::HeapDescriptor::setCpuCacheMode(
...
_MTL_INLINE void MTL::HeapDescriptor::setSparsePageSize(
...
_MTL_INLINE MTL::HazardTrackingMode MTL::HeapDescriptor::hazardTrackingMode()
  const {
...
_MTL_INLINE void MTL::HeapDescriptor::setResourceOptions(
...
_MTL_INLINE MTL::Texture* MTL::Heap::newTexture(
...
_MTL_INLINE MTL::PurgeableState MTL::Heap::setPurgeableState(
  MTL::PurgeableState state) {
...
_MTL_INLINE MTL::AccelerationStructure* MTL::Heap::newAccelerationStructure(
  NS::UInteger size, NS::UInteger offset) {
  return Object::sendMessage<MTL::AccelerationStructure*>(
