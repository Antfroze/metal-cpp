...
_NS_INLINE NS::Object* NS::NotificationCenter::addObserver(
  NS::NotificationName name, Object* pObj, void* pQueue,
...
_NS_INLINE NS::Object* NS::NotificationCenter::addObserver(
  ...
  return addObserver(name, pObj, pQueue,
                     ^(NS::Notification* pNotif) { blockFunction(pNotif); });
}
