...
class Bundle : public Referencing<Bundle> {
 public:
  ...
  class URL* URLForAuxiliaryExecutable(
    const class String* pExecutableName) const;
  ...
  class String* pathForAuxiliaryExecutable(
    const class String* pExecutableName) const;
...
_NS_INLINE NS::URL* NS::Bundle::URLForAuxiliaryExecutable(
  const String* pExecutableName) const {
...
_NS_INLINE NS::Object* NS::Bundle::objectForInfoDictionaryKey(
  const String* pKey) {
...
_NS_INLINE NS::String* NS::Bundle::localizedString(
  const String* pKey, const String* pValue /* = nullptr */,
